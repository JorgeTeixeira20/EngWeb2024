    ...
    for filename in os.listdir(directory):
        if filename.endswith('.xml'): 
            ...
            for figura in root.iter('figura'):
                ...
                imagem_path = f"../MapaRuas/texto/{imagem_path}"
            ...
            if rua_id:
                ...
                for imagem in os.listdir(f"MapaRuas/atual"):
                    if imagem.startswith(f"{rua_id}"):
                        html_rua += f"<img src='../MapaRuas/atual/{imagem}' alt='Imagem'>"
